				...
				<div class="row">
					...
					<form class="" action="login.php" method="post">
						...
						<div class="row">
							...
							<div><p style="color: #f7f7f7; font-weight: 400; margin:10px 20px;">Forgot Password? <span><a href="http://localhost/ProjectCompiler/Students/forgotpass.php">Click Here</a></span></p></div>
							
							
						</div>
                         </div>	
						<div> 
                           <p style="color: #f7f7f7; font-weight: 400; margin-top:25px;">Didn't Register? <a href="http://localhost/ProjectCompiler/"> Sign Up Here</a></p>
						</div>
