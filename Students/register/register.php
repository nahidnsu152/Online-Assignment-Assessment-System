...
$error_array =  array();     // hold the error
...
if(isset($_POST['submit'])){
    ...
    $confirm_password = strip_tags($_POST['c_password']);            //remove html tags
    $confirm_password = str_replace(' ', ' ', $confirm_password);    //remove spaces
    $confirm_password = ucfirst(strtolower($confirm_password));      //uppercase first
    ...
    //Insert values in the database
    	...
    	$query = mysqli_query($conn, "INSERT INTO teachers VALUES('','$fullname' , '$email' ,
    		'$gender' , '$phone_number' ,'$address','$StorePassword') ");
