...
include "connect.php";
include "add_student_handler.php";
include "header.php";
       ...
       <form action="#" method="POST" enctype = "multipart/form-data">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="university" placeholder="Universirty">
            
          </div>
          <div class="form-group col-md-6">
            <label >ID</label>
            <input type="integer" class="form-control" name="student_id" placeholder="ID">
          </div>
        </div>
