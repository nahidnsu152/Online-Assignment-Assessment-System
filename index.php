...
if(isset($_POST['submit'])){
    ...
    $university = strip_tags($_POST['institution']);      //remove html tags
    ...
    if(filter_var($email,FILTER_VALIDATE_EMAIL)){
     ...
     //checking is the mail already in used or not
    	$email_check = mysqli_query($conn,"select email from students where email='$email' ");
    ...
    if(empty($error_array)){
     ...
     $query = mysqli_query($conn, "INSERT INTO students VALUES('','$student_id','$fullname' , '$email' ,'$gender', '$phone_number','$university','$image' ,'$address', '$StorePassword') ");
		...
		<div class="register-full">
			<div class="register-left">
				<div class="register">
					...
					<h1> Welcome</h1>
					<p>A platform both for teachers and students to co-operate each other and share their knowledge.</p>
					<div class="content3">
						<ul>
							<li><a class="" href="http://localhost/ProjectCompiler/teacher/login.php" style="color:#222; font-weight: 700; font-family: tahoma; font-size: 16px;">Login As Teacher </a></li>
							<li><a class="read" href="http://localhost/ProjectCompiler/Students/index.php" style="color:#222; font-weight: 700; font-family: tahoma; font-size: 16px;">Login As Student</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="register-right">
				<div class="register-in">
					<h2><span class="fa fa-pencil"></span>Join As Student</h2>
					<div class="register-form">
						<form action="#" method="post" enctype = "multipart/form-data">
							<?php if(isset($_SESSION['success'])){  ?>	
                            <div style="margin-bottom:10px;" class="text-center alert alert-success">Registration Success <a href="students/index.php">Log In Here</a></div>
